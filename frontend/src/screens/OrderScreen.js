...
const OrderScreen = ({ match, history }) => {
  ...
  useEffect(() => {
   ...
   const addCreditCardPayment = async () => {
     const { data: apiLoginKey } = await axios.get("/api/config/authorizenet")
     ...
     transactionRequestType.setAmount(100.0)
              ...
              {!order.isPaid && (
                <ListGroup.Item>
                  ...
                  {!sdkReady ? (
                    ...
                    // />
                    <Button onClick={addCreditCardPayment}></Button>
                  )}
                </ListGroup.Item>
              )}
